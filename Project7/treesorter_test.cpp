...
// Requires doctest.h, treesorter.h

// Includes for code to be tested
#include "treesorter.h"      // For treesort
#include "treesorter.h"      // Double-inclusion check, for testing only
...
TEST_CASE( "treesort: object counts" )
{
    ...
    SUBCASE( "Check for proper clean-up after sort" )
    {
        MovableCounter::reset();
